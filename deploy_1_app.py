...
st.write("This app uses 6 inputs to predict the species"
         " of penguin using a model built on Penguin data"
         " Dataset!")
penguin_df = pd.read_csv(r"penguins.csv")
...
with st.form("user_input"):
    ...
    island = st.select_box("Penguin Island",
                           options = ["Biscoe","Dream",
                                      "Torgerson"])
...
body_mass, island_biscoe, island_dream,island_torgerson, sex_female, 
sex_male]])
